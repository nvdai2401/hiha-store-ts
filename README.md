...
The `styles` directory holds all the CSS files.
...
- Web font: Use Critical FOFT with Data URI with sessionStorage trick for repeat view optimization
- Persist and reselect data of Redux store to decrease request and app rerender
